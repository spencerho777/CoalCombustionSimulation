...
func _ready():
	...
	set_texture("HydrogenSprite.png")
...
func _physics_process(delta):
	...
	if collision:
		...
		if collision.collider.type == "hydrogen" and collision.collider != self:
			touching_hydrogen = collision.collider
		else:
			touching_hydrogen = null
	else:
		touching_hydrogen = null
